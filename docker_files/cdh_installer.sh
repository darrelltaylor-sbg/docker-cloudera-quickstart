...
DEBIAN_FRONTEND=noninteractive apt-get -y install hive hbase hive-server2 hbase-thrift hbase-master pig hue oozie oozie-client spark-core spark-master spark-worker spark-history-server spark-python
